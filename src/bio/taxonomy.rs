...
impl TaxonomicLevel {
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            TaxonomicLevel::Root => "root",
            TaxonomicLevel::Kingdom => "kingdom",
    ...
    pub fn depth(&self) -> usize {
        match self {
            ...
            TaxonomicLevel::Kingdom => 2,
            TaxonomicLevel::Phylum => 3,
            TaxonomicLevel::Class => 4,
            TaxonomicLevel::Order => 5,
            TaxonomicLevel::Family => 6,
            TaxonomicLevel::Genus => 7,
            TaxonomicLevel::Species => 8,
            TaxonomicLevel::Strain => 9,
            TaxonomicLevel::Unknown => 0,
            TaxonomicLevel::Root => 0,
        }
    }
...
impl TaxonomicLineage {
    ...
    pub fn to_vec(&self) -> Vec<(TaxonomicLevel, &String)> {
        let mut result: Vec<(TaxonomicLevel, &String)> = self
            .levels
            .iter()
...
mod tests {
    ...
    fn test_parse_lineage() {
        ...
        assert_eq!(
            lineage.get_level(TaxonomicLevel::Genus).unwrap(),
            "Escherichia"
        );
        assert_eq!(
